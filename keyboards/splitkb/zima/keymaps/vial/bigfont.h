// 6x8 glyphs for chars 0x20-0x5F, extracted from drivers/oled/glcdfont.c
// (GPL-2.0). Used for pixel-doubled 12x16 rendering in keymap.c.
#pragma once
#include "progmem.h"

static const unsigned char big_font[384] PROGMEM = {
